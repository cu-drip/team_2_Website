...
import { getTeams } from "../../constants.js";
            ...
            {loading ? (
                ...
                <Grid container spacing={4} justifyContent="center">
                    {teams.length === 0 ? (
                        ...
                        teams.map((team) => (
                            <Grid item key={team.id} xs={12} sm={6} md={4} lg={3} sx={{ width: "100%", maxWidth: "400px" }}>
                                    ...
                                    <CardActionArea onClick={() => handleCardClick(team.id)}>
                                        ...
                                        <CardContent>
                                            ...
                                            <Stack direction="row" spacing={1} flexWrap="wrap" sx={{ mb: 2 }}>
                                                <Chip 
                                                    icon={<GroupIcon />} 
                                                    label={`${team.currentParticipants}/${team.maxParticipants} участников`} 
                                                    size="small" 
                                                    color={team.currentParticipants === team.maxParticipants ? "success" : "default"}
                                                />
                                                <Chip 
                                                    icon={<PeopleIcon />} 
